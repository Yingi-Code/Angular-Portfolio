...
import { ILocationCoordinates } from 'src/app/app-shared/interfaces/i-location-coordinates/i-location-coordinates';
import { IWeatherRequestParam } from 'src/app/app-shared/interfaces/i-weather-request-param/i-weather-request-param';
import { ICurrentWeather } from 'src/app/app-shared/interfaces/i-current-weather/i-current-weather';
import { WeatherForecastService } from 'src/app/app-shared/services/weather-forecast/weather-forecast.service';
...
export class WeatherForecastComponent implements OnInit, OnDestroy {
  ...
  constructor(private readonly geoLocationService$: GeolocationService, private weatherService: WeatherForecastService) {
